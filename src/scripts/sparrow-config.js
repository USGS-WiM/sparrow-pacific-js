...
var serviceBaseURL =
    "https://sparrowtest.wim.usgs.gov/arcgis/rest/services/SparrowPacific/SparrowPacific/MapServer/"; //important! UPDATE rest service URL
...
var dynamicBorderLayers = ["Catchment", "HUC8 watershed", "HUC4 hydrologic subregion"]; //Aggregate layer choices placed in this array will have dynamic borders.  Each string MUST MATCH the text in the Group Results By Select to work.
...
var phosphorusShapefileURL = rootURL + "pacific_cats_results_tp.zip";
var streamflowShapefileURL = rootURL + "pacific_cats_results_q.zip";
var sedimentShapefileURL = rootURL + "pacific_cats_results_ss.zip";
var nitrogenShapefileURL = rootURL + "pacific_cats_results_tn.zip";
...
var streamflowSourceDefinitions = {
    ...
    s2: "Inter - basin transfers",
    s3: "Local transfers",
    s4: "Springs",
    s5: "Wastewater treatment discharge",
    s6: "Irrigation runoff"
};
